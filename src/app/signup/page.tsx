                ...
                <div className="h-full">
                    <div
                        ...
                        <div className="md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                            <h1 className="mb-4 text-4xl font-semibold">{isLoading ? 'Proccessing ' : 'Sign up'}</h1>
                            ...
                            <div className="text-center lg:text-left mb-3">
                                ...
                                <p className="italic font-mono mt-2">You have already acounnt vist <Link href="/login"><b>Login.</b></Link></p>
                            </div>
                        </div>
                    </div>
                </div>
...
function post(arg0: string, user: { email: string; password: string; username: string; }) {
